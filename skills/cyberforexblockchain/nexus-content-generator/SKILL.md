...
description: "Create blog posts, social media, emails, marketing copy"
version: 1.0.0
capabilities:
  - id: invoke-content-generator
    description: "Create blog posts, social media, emails, marketing copy"
permissions:
  network: true
  filesystem: false
...
> NEXUS Agent-as-a-Service on Cardano | Price: $0.40/request

## When to use

Use when you need blog posts, social media content, marketing copy, or any written content.
...
curl -X POST https://ai-service-hub-15.emergent.host/api/original-services/content-generator \
  ...
  -d '{"topic": "decentralized AI", "content_type": "blog_post", "tone": "professional"}'
```

**Endpoint:** `https://ai-service-hub-15.emergent.host/api/original-services/content-generator`
**Method:** POST
**Headers:**
...
|-----|--------|-----------|
| `https://ai-service-hub-15.emergent.host/api/original-services/content-generator` | POST | Input parameters as JSON body |
