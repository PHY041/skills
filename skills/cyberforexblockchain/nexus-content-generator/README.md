...
**AI Content Generator** — Create blog posts, social media, emails, marketing copy
...
```bash
clawhub install nexus-content-generator
```

Or manually copy the `SKILL.md` to your OpenClaw skills directory:

```bash
cp SKILL.md ~/.openclaw/skills/nexus-content-generator/SKILL.md
```
...
- **$0.40** per request (paid in ADA via Masumi Protocol)
