...
KEYWORDS = ['cyberattack', 'ransomware', 'data breach', 'hack', 'zero-day', 'malware', 'cyber espionage', 'infrastructure attack', 'power grid', 'CISA', 'cybersecurity legislation', 'data protection', 'phishing', 'DDoS', 'supply chain hack', 'SolarWinds', 'critical infrastructure', 'cyber warfare']
...
def run(live: bool = False) -> None:
    ...
    print(f"[polymarket-cybersecurity-trader] mode={mode} max_pos=${MAX_POSITION} min_vol=${MIN_VOLUME} max_spread={MAX_SPREAD:.0%} min_days={MIN_DAYS}")
